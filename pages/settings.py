...
## -------------------------------------------------------------------------------------------------
    ...
    with st.popover(_("Background Image Settings")):
        new_image_URL = st.text_input(_("URL of image to be used for background: "), value=(db_settings["backgroundImageURL"] if db_settings["backgroundImageURL"][0:8] == "https://" else ""))
